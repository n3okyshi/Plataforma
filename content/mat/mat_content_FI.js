...
window.registrarTeoria({
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Onde estão as coisas?</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Aprendemos a nos localizar usando o próprio corpo. O que está perto? O que está longe? O que está na sua esquerda?
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🤸 Brincadeira:</p>
            <p class="text-gray-700 dark:text-gray-300">"O Mestre Mandou": levantar a mão direita, colocar a mão na cabeça, ficar embaixo da mesa.</p>
        </div>
    </div>
    `,

    "Figuras Planas e Espaciais": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Formas do Mundo</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Diferença entre o desenho no papel (achatado) e o objeto real (sólido) que a gente consegue segurar.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⚽ Exemplo:</p>
            <p class="text-gray-700 dark:text-gray-300">O círculo parece uma pizza ou um relógio. A esfera parece uma bola de futebol.</p>
        </div>
    </div>
    `,

    // Unidade: Números e Operações
    "Contagem e Quantidade (0 a 10)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Vamos Contar!</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Relacionar o número com a quantidade de dedinhos ou objetos. Aprendemos também que o <strong>Zero</strong> significa "nenhum".
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🖐️ Prática:</p>
            <p class="text-gray-700 dark:text-gray-300">Contar um a um: lápis no estojo, cadeiras na sala e colegas na fila.</p>
        </div>
    </div>
    `,

    "Classificação e Sequências (Padrões)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Seguindo o Padrão</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Organizar brinquedos por cor ou tamanho e descobrir qual é a próxima figura da fila.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔴🔵🔴 O que vem depois?</p>
            <p class="text-gray-700 dark:text-gray-300">Se a fila é: Vermelho, Azul, Vermelho... a próxima cor deve ser Azul!</p>
        </div>
    </div>
    `,

    "Comparação de Quantidades": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Quem tem mais?</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Comparar coleções para saber onde "tem muito", onde "tem pouco" ou se tem a "mesma quantidade".
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍬 Dica:</p>
            <p class="text-gray-700 dark:text-gray-300">Podemos ligar um objeto de um grupo a um objeto do outro grupo. O que sobrar é o que tem mais.</p>
        </div>
    </div>
    `,

    "Ordem Crescente e Decrescente": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Subindo e Descendo</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Organizar os números do menor para o maior (crescente) e do maior para o menor (decrescente).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🏠 Vizinhos:</p>
            <p class="text-gray-700 dark:text-gray-300">Quem mora antes do 5? O 4 (Antecessor). Quem mora depois? O 6 (Sucessor).</p>
        </div>
    </div>
    `,

    "Números Ordinais": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">A Fila</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Números que indicam ordem e posição: Primeiro (1º), Segundo (2º), Terceiro (3º)...
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🏆 Competição:</p>
            <p class="text-gray-700 dark:text-gray-300">Usamos muito em corridas para saber quem ganhou medalha de ouro, prata e bronze.</p>
        </div>
    </div>
    `,

    "Ideias da Adição e Subtração": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Juntar e Tirar</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Continhas iniciais. Adição é ganhar/juntar. Subtração é perder/dar/tirar.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍎 Historinha:</p>
            <p class="text-gray-700 dark:text-gray-300">"Eu tinha 3 maçãs e ganhei mais 2. Com quantas fiquei?" (Adição). "Comi uma maçã. Quantas sobraram?" (Subtração).</p>
        </div>
    </div>
    `,

    "Números até 100 e Dezenas Exatas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Números Grandes</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Começamos a contar além dos dedos das mãos, fazendo montinhos de 10 em 10.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔟 Dezenas:</p>
            <p class="text-gray-700 dark:text-gray-300">10, 20, 30, 40... É muito mais rápido contar assim do que contar de 1 em 1!</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Medindo as Coisas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Medir usando o corpo (palmos, passos) e comparar: O que é mais pesado? O que cabe mais água?
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🐘 Pesado ou Leve?</p>
            <p class="text-gray-700 dark:text-gray-300">Uma pena é leve. Um elefante é pesado. Uma garrafa cheia é mais pesada que uma vazia.</p>
        </div>
    </div>
    `,

    "Tempo e Calendário": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">O Tempo Passa</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Entender o Ontem (já passou), Hoje (agora) e Amanhã (vai acontecer). Leitura dos dias da semana no calendário.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📅 Rotina:</p>
            <p class="text-gray-700 dark:text-gray-300">Identificar os dias que tem escola e os dias de descanso (Sábado e Domingo).</p>
        </div>
    </div>
    `,

    "Sistema Monetário Brasileiro (Introdução)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Nosso Dinheirinho</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Conhecer as moedas e as notas do Real.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🛒 Mercadinho:</p>
            <p class="text-gray-700 dark:text-gray-300">Brincar de compra e venda ajuda a entender que precisamos trocar dinheiro por coisas.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">A Casa das Centenas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Conhecendo números maiores! Usamos o <strong>Material Dourado</strong> para entender que 10 barrinhas formam uma placa (100).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧱 O Jogo da Troca:</p>
            <p class="text-gray-700 dark:text-gray-300">Juntou 10 cubinhos? Troca por uma barrinha. Juntou 10 barrinhas? Troca por uma placa (Centena)!</p>
        </div>
    </div>
    `,

    "Estimativa e Comparação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Maior ou Menor?</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Adivinhar "quantos têm" sem contar um por um e usar os sinais de comparação: <strong>></strong> (maior) e <strong><</strong> (menor).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🐊 O Jacaré Comilão:</p>
            <p class="text-gray-700 dark:text-gray-300">Dica: A boca do jacaré sempre abre para o lado do número <strong>maior</strong> (ele quer comer mais!). Ex: 5 < 9.</p>
        </div>
    </div>
    `,

    "Algoritmos da Adição": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Conta de Mais (Armada)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Montando a continha em pé. Aprendemos o "vai um" (reserva) quando a soma passa de 9.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">☝️ Subir o 1:</p>
            <p class="text-gray-700 dark:text-gray-300">Quando a casa das unidades fica cheia (dá 10 ou mais), a dezena tem que subir para o andar de cima.</p>
        </div>
    </div>
    `,

    "Algoritmos da Subtração": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Conta de Menos (Pedir Emprestado)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Tirar, completar ou comparar. E o que fazer quando o número de cima é menor que o de baixo?
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🚪 Toc-Toc:</p>
            <p class="text-gray-700 dark:text-gray-300">Batemos na porta do vizinho (dezena) e pedimos 1 emprestado. O vizinho diminui e nós aumentamos!</p>
        </div>
    </div>
    `,

    "Sistema de Numeração Decimal (até 1000)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Até o Mil!</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Caminhando na reta numérica até chegar no 1000. Quem vem antes (antecessor) e quem vem depois (sucessor)?
        </p>
        

[Image of number line up to 1000]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📍 Valor Posicional:</p>
            <p class="text-gray-700 dark:text-gray-300">O número 5 vale 5 na unidade, 50 na dezena e 500 na centena. O lugar onde ele senta muda tudo!</p>
        </div>
    </div>
    `,

    "Introdução à Multiplicação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Multiplicação (Vezes)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Somar a mesma coisa várias vezes. Construção das primeiras tabuadas (2, 3, 4 e 5).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">✖️ Grupos:</p>
            <p class="text-gray-700 dark:text-gray-300">3 x 4 significa "3 grupos com 4 coisas dentro". Dobro é 2x, Triplo é 3x.</p>
        </div>
    </div>
    `,
    ...
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Cubo, pirâmide, cone, cilindro e esfera. Aprendemos a contar as partes: pontas (vértices) e lados (faces).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧊 Rola ou não rola?</p>
            <p class="text-gray-700 dark:text-gray-300">Objetos redondos (esfera, cone) rolam. Objetos quadrados (cubo) ficam parados.</p>
        </div>
    </div>
    `,

    "Figuras Planas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Figuras Planas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Quadrados, retângulos, triângulos e círculos. Diferença entre a linha de fora (contorno) e a parte de dentro (interior).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🖼️ Moldura e Quadro:</p>
            <p class="text-gray-700 dark:text-gray-300">O contorno é como a moldura. O interior é onde pintamos o desenho.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Usando a Régua</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Começamos a usar unidades de verdade: Centímetros (cm) e Metros (m) para tamanho; Quilo (kg) para peso; Litro (L) para líquidos.
        </p>
        

[Image of ruler and measuring tape]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📏 Do Zero:</p>
            <p class="text-gray-700 dark:text-gray-300">Para medir certo com a régua, temos que começar colocando o objeto no tracinho do <strong>Zero</strong>, não no começo da régua!</p>
        </div>
    </div>
    `,
    ...
    // Unidade: Números e Operações
    "Leitura e Escrita de Números até 1000": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Números até 1000</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Consolidando o sistema decimal. Aprendemos a compor (juntar) e decompor (separar) os números: Centena, Dezena e Unidade.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📝 Por Extenso:</p>
            <p class="text-gray-700 dark:text-gray-300">Escrever o nome do número ajuda a entender o valor. Ex: 234 = Duzentos e trinta e quatro.</p>
        </div>
    </div>
    `,

    "A Quarta Ordem (Unidade de Milhar)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">A Casa do Milhar</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Depois do 999 vem o <strong>1.000</strong>! Entramos na 4ª ordem. Trabalhamos com números de quatro algarismos na reta numérica.
        </p>
        

[Image of place value chart with thousands]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧊 O Cubão:</p>
            <p class="text-gray-700 dark:text-gray-300">No Material Dourado, 10 placas de cem formam o Cubão de Mil.</p>
        </div>
    </div>
    `,

    "Estratégias de Cálculo (Mental e Escrito)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Estratégias de Cálculo</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Como fazer contas de cabeça (estimativa) e como verificar se a conta está certa (Prova Real).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔄 Prova Real:</p>
            <p class="text-gray-700 dark:text-gray-300">A soma e a subtração são operações inversas. Se você somou, subtraia para conferir!</p>
        </div>
    </div>
    `,

    "Algoritmo da Multiplicação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Conta de Multiplicar</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Avançando das somas repetidas para a conta armada. Resolução de problemas de combinatória simples (roupas, sabores).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">👕 Combinando:</p>
            <p class="text-gray-700 dark:text-gray-300">Se tenho 2 bermudas e 3 camisetas, posso fazer 2 x 3 = 6 trajes diferentes.</p>
        </div>
    </div>
    `,

    "Introdução à Divisão": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Dividir e Repartir</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Duas ideias principais: "Repartir igualmente" (dar um pra cada) e "Medida" (quantos cabem?).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍰 As Partes:</p>
            <p class="text-gray-700 dark:text-gray-300">Metade (dividir por 2), Terça parte (dividir por 3) e Décima parte (dividir por 10).</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Sólidos e Planificações</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Classificação avançada. Aprendemos a "abrir" as caixas (planificação) e contamos os elementos: Vértices (pontas), Faces (lados) e Arestas (linhas).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📦 Abrindo a Caixa:</p>
            <p class="text-gray-700 dark:text-gray-300">Planificar é desenhar no papel como o sólido ficaria se fosse desmontado.</p>
        </div>
    </div>
    `,

    "Congruência e Malhas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Figuras Iguais (Congruentes)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Usando o papel quadriculado para desenhar e identificar figuras que são gêmeas idênticas.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔍 A Regra:</p>
            <p class="text-gray-700 dark:text-gray-300">Para ser congruente, tem que ter a mesma forma e o mesmo tamanho. Se mudar o tamanho, não vale!</p>
        </div>
    </div>
    `,
    ...
    // Unidade: Grandezas e Medidas
    "Horas e Minutos": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Que horas são?</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Leitura de relógios de ponteiro e digitais. Cálculo de quanto tempo as coisas demoram (duração).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⌚ Tabuada do 5:</p>
            <p class="text-gray-700 dark:text-gray-300">No relógio de ponteiro, os minutos pulam de 5 em 5. O número 1 vale 5 min, o 6 vale 30 min (meia hora).</p>
        </div>
    </div>
    `,

    "Sistema Monetário": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Comprando e Dando Troco</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Resolver problemas reais de compra e venda. Calcular quanto sobra de dinheiro (troco).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">💰 Centavos:</p>
            <p class="text-gray-700 dark:text-gray-300">Lembre-se que 100 centavos formam 1 Real. Às vezes precisamos trocar notas por moedas para dar o troco.</p>
        </div>
    </div>
    `,

    "Medidas e Estimativas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Medindo com Precisão</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Aprofundamento nas unidades: milímetros (mm), centímetros (cm), metros (m), gramas (g) e mililitros (mL).
        </p>
        

[Image of measuring cup and scale]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📏 Escolha Certa:</p>
            <p class="text-gray-700 dark:text-gray-300">Usamos régua para o caderno, fita métrica para a cintura e balança para a comida.</p>
        </div>
    </div>
    `,
    ...
    // Unidade: Números Naturais
    "Números Naturais até a Dezena de Milhar": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Dez Mil e além!</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Chegamos à <strong>5ª ordem</strong>! Lemos, escrevemos e comparamos números grandões, como 15.000 ou 99.999.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📍 O Ponto Mágico:</p>
            <p class="text-gray-700 dark:text-gray-300">Usamos um ponto para separar a classe dos milhares. Ele ajuda a ler: o número antes do ponto é "mil". Ex: 23.400 (Vinte e três <strong>mil</strong> e quatrocentos).</p>
        </div>
    </div>
    `,

    // Unidade: Espaço e Forma
    "Localização, Deslocamento e Simetria": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Mapas e Espelhos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Usando coordenadas (Batalha Naval) para achar coisas e descobrindo a <strong>Simetria</strong> (o efeito de espelho).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🦋 Eixo de Simetria:</p>
            <p class="text-gray-700 dark:text-gray-300">É a linha imaginária que divide o desenho em duas partes iguais. Se dobrarmos o papel nessa linha, as partes se encaixam perfeitamente.</p>
        </div>
    </div>
    `,

    "Ângulos e Polígonos": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Giros e Cantos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            O ângulo é uma abertura ou um giro. Aprendemos a identificar o famoso <strong>Ângulo Reto</strong> (o canto quadrado).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📐 O Canto da Lousa:</p>
            <p class="text-gray-700 dark:text-gray-300">O ângulo reto (90º) está em todo lugar: no canto do caderno, na quina da mesa e nas paredes.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Medidas e Temperatura</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Resolver problemas transformando metros em centímetros e lendo termômetros em <strong>graus Celsius (°C)</strong>.
        </p>
        

[Image of thermometer celsius scale]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🌡️ Quente ou Frio?</p>
            <p class="text-gray-700 dark:text-gray-300">0°C é quando a água vira gelo. 100°C é quando a água ferve. Nosso corpo fica em torno de 36°C.</p>
        </div>
    </div>
    `,

    "Perímetro e Área": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Contorno e Superfície</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Não confunda! <strong>Perímetro</strong> é a volta (cerca). <strong>Área</strong> é o preenchimento (piso).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧱 Contando Quadradinhos:</p>
            <p class="text-gray-700 dark:text-gray-300">Para medir a área no papel quadriculado, contamos quantos quadradinhos cabem dentro da figura.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Problemas Grandes</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Usando a adição e subtração para resolver desafios com números grandes, aplicando propriedades como a comutativa (trocar a ordem não altera a soma).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🕵️ Detetive:</p>
            <p class="text-gray-700 dark:text-gray-300">Em problemas, circule os dados importantes e pergunte: "Estou juntando ou estou comparando?"</p>
        </div>
    </div>
    `,

    "Algoritmo e Propriedades": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Multiplicação por 2 Algarismos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            O desafio aumenta! Multiplicar por números como 12, 25 ou 30.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⚠️ Pulo do Gato:</p>
            <p class="text-gray-700 dark:text-gray-300">Quando for multiplicar a dezena (o segundo número), não esqueça de colocar o <strong>Zero</strong> ou deixar um espaço vazio na linha de baixo!</p>
        </div>
    </div>
    `,

    "Algoritmo da Divisão": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">A Conta de Dividir</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Usando a chave para divisões maiores. Entendendo o papel do <strong>Resto</strong>.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🛑 Regra do Resto:</p>
            <p class="text-gray-700 dark:text-gray-300">O resto nunca pode ser maior ou igual ao número que está na chave (divisor). Se for, dá para dividir mais!</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">O Mundo das Frações</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Quando o inteiro é partido em pedaços iguais. Conhecendo 1/2 (meio), 1/3 (um terço) e 1/4 (um quarto).
        </p>
        

[Image of pizza slices fractions]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍰 Quem é quem?</p>
            <p class="text-gray-700 dark:text-gray-300">O número de baixo (Denominador) diz em quantos pedaços cortamos. O de cima (Numerador) diz quantos pegamos.</p>
        </div>
    </div>
    `,

    "Números Decimais": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Números com Vírgula</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Introdução aos Décimos (0,1) e Centésimos (0,01). A melhor forma de entender é usando dinheiro!
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">💰 Moedinhas:</p>
            <p class="text-gray-700 dark:text-gray-300">1 Real é o inteiro. 10 centavos é um décimo (0,10). 1 centavo é um centésimo (0,01).</p>
        </div>
    </div>
    `,
    ...
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Expandindo nossos horizontes para números gigantes! Leitura, escrita e o valor de cada algarismo até a casa dos milhões.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🌍 População:</p>
            <p class="text-gray-700 dark:text-gray-300">Usamos esses números para contar habitantes de países. Ex: O Brasil tem mais de 200 milhões de pessoas!</p>
        </div>
    </div>
    `,

    // Unidade: Espaço e Forma
    "Plano Cartesiano e Sólidos": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Coordenadas e Sólidos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Localização de pontos no mapa (Par Ordenado) e estudo profundo dos sólidos (Prismas e Pirâmides).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🗺️ Batalha Naval:</p>
            <p class="text-gray-700 dark:text-gray-300">Para achar um ponto, primeiro andamos para o lado (eixo X) e depois subimos (eixo Y).</p>
        </div>
    </div>
    `,

    "Polígonos e Ampliação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Ampliação e Redução</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Usando malhas quadriculadas para mudar o tamanho das figuras sem deformá-las.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔍 Proporção:</p>
            <p class="text-gray-700 dark:text-gray-300">Se dobrarmos o tamanho do lado, a figura fica maior, mas o formato continua igualzinho.</p>
        </div>
    </div>
    `,
    ...
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Organizando as contas. Introdução aos parênteses e a ordem de resolução.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⚠️ Ordem:</p>
            <p class="text-gray-700 dark:text-gray-300">Primeiro resolvemos o que está dentro dos <strong>(parênteses)</strong>, depois o que está fora.</p>
        </div>
    </div>
    `,

    "Estratégias de Cálculo": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Princípio da Contagem</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Multiplicação e Divisão aplicadas a problemas de combinação.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🌳 Árvore de Possibilidades:</p>
            <p class="text-gray-700 dark:text-gray-300">Para saber quantas combinações existem, basta multiplicar as opções. (Ex: 3 sorvetes x 2 coberturas = 6 tipos).</p>
        </div>
    </div>
    `,

    // Unidade: Racionais e Porcentagem
    "Operações com Frações e Equivalência": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Frações Equivalentes</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Descobrindo que 1/2 é a mesma coisa que 2/4 ou 4/8. Cálculo da fração de uma quantidade.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍫 Regra Prática:</p>
            <p class="text-gray-700 dark:text-gray-300">Para achar a fração de um número (ex: 1/3 de 12), dividimos pelo de baixo e multiplicamos pelo de cima.</p>
        </div>
    </div>
    `,

    "Números Decimais e Porcentagem": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Decimais e Porcentagem</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Tudo está conectado! 50% é a mesma coisa que metade (1/2) ou 0,5.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">💯 Por cento:</p>
            <p class="text-gray-700 dark:text-gray-300">O símbolo % significa "dividido por 100". 25% é o mesmo que 25 pedacinhos de 100.</p>
        </div>
    </div>
    `,

    // Unidade: Grandezas e Medidas
    "Volume e Outras Grandezas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Volume (Espaço)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Conceito inicial de volume através do empilhamento de cubinhos.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📦 Enchendo a caixa:</p>
            <p class="text-gray-700 dark:text-gray-300">Volume é o espaço que um objeto ocupa. Contamos quantos cubinhos unitários cabem dentro dele.</p>
        </div>
    </div>
    `,
    ...
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
        ...
        <div>
            ...
            <div class="flex gap-3">
                <button onclick="app.app.verificarQuiz(this, false, 'fb-atv40')" class="flex-1 font-bold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 p-3 rounded-xl transition-all">
                    Verdadeiro
                </button>
                <button onclick="app.app.verificarQuiz(this, true, 'fb-atv40')" class="flex-1 font-bold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 p-3 rounded-xl transition-all">
                    Falso
                </button>
            </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button onclick="app.verificarAtividadeValor('sel-41a', 'ordem')" class="bg-brand-blue text-white px-3 rounded">OK</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button onclick="app.verificarAtividadeValor('sel-41b', 'contagem')" class="bg-brand-blue text-white px-3 rounded">OK</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button onclick="app.verificarAtividadeValor('sel-41c', 'codigo')" class="bg-brand-blue text-white px-3 rounded">OK</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="flex items-center gap-2 justify-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                <span>27</span>
                <select id="atv49a" class="bg-white dark:bg-gray-700 border rounded" onchange="app.verificarAtividadeValor(this.id, '<')"><option>?</option><option><</option><option>></option></select>
                <span>35</span>
            </div>
            <div class="flex items-center gap-2 justify-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                <span>169</span>
                <select id="atv49b" class="bg-white dark:bg-gray-700 border rounded" onchange="app.verificarAtividadeValor(this.id, '>')"><option>?</option><option><</option><option>></option></select>
                <span>167</span>
            </div>
            <div class="flex items-center gap-2 justify-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                <span>4.099</span>
                <select id="atv49c" class="bg-white dark:bg-gray-700 border rounded" onchange="app.verificarAtividadeValor(this.id, '<')"><option>?</option><option><</option><option>></option></select>
                <span>4.100</span>
            </div>
            <div class="flex items-center gap-2 justify-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                <span>5.001</span>
                <select id="atv49d" class="bg-white dark:bg-gray-700 border rounded" onchange="app.verificarAtividadeValor(this.id, '>')"><option>?</option><option><</option><option>></option></select>
                <span>5.000</span>
            </div>
        </div>
    </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-600 pt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="px-2 py-1 bg-white dark:bg-gray-700 border rounded text-xs">143</button>
                </div>
                <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    <span class="text-sm">b) Menor número par?</span>
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="px-2 py-1 bg-white dark:bg-gray-700 border rounded text-xs">62</button>
                </div>
                <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    <span class="text-sm">c) 6 a mais que 140?</span>
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="px-2 py-1 bg-white dark:bg-gray-700 border rounded text-xs">146</button>
                </div>
                <div class="flex justify-between items-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
...
<h3 class="text-2xl font-bold text-brand-blue mb-4">Testes Oficiais</h3>
    ...
    <div class="mt-8 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t1')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) 91 875</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t1')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) 98 715</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t1')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) 98 751</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t1')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) 97 851</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex flex-col gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t2')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) dividido por 1.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t2')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) dividido por 10.</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t2')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) multiplicado por 10.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t2')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) multiplicado por 100.</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t3')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) 5</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t3')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) 75</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t3')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) 500</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t3')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) 7500</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="flex flex-col gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t4')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) dois números de três algarismos.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t4')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) três números de três algarismos.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t4')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) quatro números de três algarismos.</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t4')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) seis números de três algarismos.</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t5')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) 6 e 8</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t5')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) 8 e 2</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t5')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) 2 e 4</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t5')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) 4 e 7</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t6')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) Casa.</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t6')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) Fazenda do tio.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t6')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) Praia.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t6')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) Sítio da vovó.</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-4 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t7')" class="text-center p-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-bold dark:text-gray-300">T</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t7')" class="text-center p-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-bold dark:text-gray-300">S</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t7')" class="text-center p-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-bold dark:text-gray-300">R</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t7')" class="text-center p-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-bold dark:text-gray-300">Q</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t8')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) 528.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t8')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) 258.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t8')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) 825.</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t8')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) 852.</button>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t9')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">a) Rio de Janeiro.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t9')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">b) Cidade do México.</button>
            <button onclick="app.app.verificarQuiz(this, false, 'fb-t9')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">c) São Paulo.</button>
            <button onclick="app.app.verificarQuiz(this, true, 'fb-t9')" class="text-left p-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all dark:text-gray-300">d) Quito.</button>
        </div>
    ...
    <div class="mt-8 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-xl border border-gray-200 dark:border-gray-600">
                ...
                <div class="flex flex-col gap-2">
                    <button onclick="app.app.verificarQuiz(this, true, 'fb-check1a')" class="text-left text-sm p-2 rounded bg-white dark:bg-gray-700 border hover:bg-blue-50 transition-all">∩∩∩ ||</button>
                    <button onclick="app.app.verificarQuiz(this, false, 'fb-check1a')" class="text-left text-sm p-2 rounded bg-white dark:bg-gray-700 border hover:bg-blue-50 transition-all">∩∩ |||</button>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-xl border border-gray-200 dark:border-gray-600">
                ...
                <div class="flex flex-col gap-2">
                    <button onclick="app.app.verificarQuiz(this, false, 'fb-check1d')" class="text-left text-sm p-2 rounded bg-white dark:bg-gray-700 border hover:bg-blue-50 transition-all">୭୭ ∩ ||||</button>
                    <button onclick="app.app.verificarQuiz(this, true, 'fb-check1d')" class="text-left text-sm p-2 rounded bg-white dark:bg-gray-700 border hover:bg-blue-50 transition-all">୭୭୭ ∩ ||||</button>
                </div>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-2">
                <div class="text-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <select id="pico-A" class="w-full text-xs" onchange="app.verificarAtividadeValor(this.id, 'bandeira')">
                ...
                <div class="text-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <select id="pico-B" class="w-full text-xs" onchange="app.verificarAtividadeValor(this.id, 'agulhas')">
                ...
                <div class="text-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <select id="pico-C" class="w-full text-xs" onchange="app.verificarAtividadeValor(this.id, 'neblina')">
                ...
                <div class="text-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <select id="pico-D" class="w-full text-xs" onchange="app.verificarAtividadeValor(this.id, 'marco')">
                ...
                <div class="text-center bg-gray-50 dark:bg-gray-800 p-2 rounded">
                    ...
                    <select id="pico-E" class="w-full text-xs" onchange="app.verificarAtividadeValor(this.id, 'mina')">
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <button onclick="app.app.verificarQuiz(this, false, null)" class="px-3 py-1 border rounded text-xs">458 e 485</button>
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="px-3 py-1 border rounded text-xs bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300 font-bold">548 e 845</button>
                    <button onclick="app.app.verificarQuiz(this, false, null)" class="px-3 py-1 border rounded text-xs">584 e 854</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-6 bg-white dark:bg-brand-darkCard p-6 rounded-3xl border-2 border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        <div class="space-y-3">
            <div class="flex flex-col gap-1 p-2 border rounded bg-gray-50 dark:bg-gray-800">
                ...
                <div class="flex gap-2">
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="text-xs bg-white border px-2 py-1 rounded hover:bg-green-100">Verdadeiro</button>
                    <button onclick="app.app.verificarQuiz(this, false, null)" class="text-xs bg-white border px-2 py-1 rounded hover:bg-red-100">Falso</button>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-1 p-2 border rounded bg-gray-50 dark:bg-gray-800">
                ...
                <div class="flex gap-2">
                    <button onclick="app.app.verificarQuiz(this, false, null)" class="text-xs bg-white border px-2 py-1 rounded hover:bg-green-100">Verdadeiro</button>
                    <button onclick="app.app.verificarQuiz(this, true, null)" class="text-xs bg-white border px-2 py-1 rounded hover:bg-red-100">Falso</button>
                </div>
...
[Image of pie chart with percentages]
    ...
    // Unidade: Números, dos Naturais aos Racionais, e Sequências
    "Conjuntos Numéricos": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Revisão: Conjuntos Numéricos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Aprofundamos a relação entre Naturais (N), Inteiros (Z) e Racionais (Q). O foco é transformar <strong>dízimas periódicas</strong> em frações geratrizes e localizar esses números na reta.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">💡 Lembre-se:</p>
            <p class="text-gray-700 dark:text-gray-300">Todo número que pode ser escrito como fração (mesmo que infinito e periódico) é Racional.</p>
        </div>
    </div>
    `,

    "Potenciação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Potenciação e Notação Científica</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Exploramos expoentes inteiros (incluindo negativos, que invertem a base) e a <strong>Notação Científica</strong> para lidar com números astronômicos ou microscópicos.
        </p>
        

[Image of scientific notation examples]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🚀 Aplicação:</p>
            <p class="text-gray-700 dark:text-gray-300">Usamos potências de 10 para escrever a distância entre planetas ou o tamanho de uma célula.</p>
        </div>
    </div>
    `,

    "Radiciação": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Radiciação</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Cálculo de raízes exatas e técnicas de aproximação para raízes não exatas.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧊 Geometria:</p>
            <p class="text-gray-700 dark:text-gray-300">Identificamos <strong>Quadrados Perfeitos</strong> (áreas de quadrados) e <strong>Cubos Perfeitos</strong> (volumes de cubos).</p>
        </div>
    </div>
    `,

    "Sequências": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Sequências e Padrões</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Identificação de padrões numéricos e figurais. Diferenciamos sequências recursivas (dependem do anterior) das não recursivas.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔍 Generalização:</p>
            <p class="text-gray-700 dark:text-gray-300">O objetivo final é encontrar a <strong>Lei de Formação</strong> (fórmula) que permite calcular qualquer termo da sequência.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">A Linguagem da Estatística</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Definições fundamentais: População (todos) vs Amostra (parte).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📊 Tipos de Variáveis:</p>
            <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 mt-2">
                <li><strong>Qualitativas:</strong> Qualidades (Nominais/Ordinais).</li>
                <li><strong>Quantitativas:</strong> Números (Discretas/Contínuas).</li>
            </ul>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Leitura de Gráficos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Interpretação e construção de gráficos: barras, linhas, setores (pizza) e histogramas.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🎯 Escolha Certa:</p>
            <p class="text-gray-700 dark:text-gray-300">Aprender qual gráfico é o "mais honesto" e adequado para cada tipo de variável apresentada.</p>
        </div>
    </div>
    `,

    "Medidas de Tendência Central": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Média, Moda e Mediana</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Cálculo das medidas que resumem um conjunto de dados.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⚖️ Diferenças:</p>
            <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 mt-2">
                <li><strong>Média:</strong> Equilíbrio (simples ou ponderada).</li>
                <li><strong>Mediana:</strong> O termo do meio.</li>
                <li><strong>Moda:</strong> O mais popular.</li>
            </ul>
        </div>
    </div>
    `,

    "Princípio Multiplicativo ou Princípio Fundamental da Contagem (PFC)": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Princípio Multiplicativo (PFC)</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Técnica para resolver problemas de contagem multiplicando as opções de escolha em cada etapa.
        </p>
...
[Image of probability tree diagram]
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🧠 Lógica pura:</p>
            <p class="text-gray-700 dark:text-gray-300">Não precisamos de fórmulas complexas ainda, apenas organizar o pensamento (árvore de possibilidades) e multiplicar.</p>
        </div>
    </div>
    `,

    "Probabilidade": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Cálculo de Probabilidade</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Estudo de eventos simples e compostos. Introdução à noção frequentista através de experimentos.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🎲 A Fórmula:</p>
            <p class="text-gray-700 dark:text-gray-300">Probabilidade = (Resultados Favoráveis) / (Total de Possibilidades).</p>
        </div>
    </div>
    `,

    // Unidade: Área e Volume
    "Retomando e Aprofundando o Cálculo de Medida de Área": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Áreas Planas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Cálculo de área de polígonos (triângulos, quadriláteros) e aprofundamento no círculo.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">pizza🍕 Círculo:</p>
            <p class="text-gray-700 dark:text-gray-300">Além da área total (πr²), aprendemos a calcular "fatias" (setor circular) e "bordas" (coroa circular).</p>
        </div>
    </div>
    `,

    "Retomando e Aprofundando o Cálculo de Medidas de Volume e Medidas de Capacidade": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Volume e Capacidade</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Cálculo do volume de prismas retos e cilindros.
        </p>
        

[Image of volume of cylinder and prism]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🚰 Conversão:</p>
            <p class="text-gray-700 dark:text-gray-300">Foco na resolução de problemas práticos que exigem converter volume (m³, dm³) em capacidade (Litros).</p>
        </div>
    </div>
    `,

    // Unidade: Expressões Algébricas, Equações e Proporcionalidade
    "Expressões Algébricas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Cálculo Literal</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Introdução aos monômios e polinômios. Aprendemos a identificar graus e realizar operações básicas.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🍎 Termos Semelhantes:</p>
            <p class="text-gray-700 dark:text-gray-300">Só podemos somar ou subtrair termos que tenham a mesma parte literal (ex: $2x + 3x = 5x$, mas $2x + 3y$ não mistura).</p>
        </div>
    </div>
    `,

    "Equações": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Equações Avançadas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Resolução de equações do 1º grau mais complexas, com coeficientes racionais e fracionários.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔧 Ferramentas:</p>
            <p class="text-gray-700 dark:text-gray-300">Uso intensivo da <strong>propriedade distributiva</strong> (o "chuveirinho") para organizar a equação antes de isolar o X.</p>
        </div>
    </div>
    `,

    "Proporcionalidade": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Proporcionalidade</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Estudo aprofundado de grandezas diretas e inversas.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">⚙️ Aplicações:</p>
            <p class="text-gray-700 dark:text-gray-300">Resolução de problemas envolvendo <strong>regra de três composta</strong> e divisão de lucros/custos em partes proporcionais.</p>
        </div>
    </div>
    `,

    // Unidade: Lugares Geométricos e Construções Geométricas
    "Construções Geométricas com Régua, Esquadro, Transferidor e Compasso": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Desenho Geométrico</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Técnicas manuais para desenhar retas paralelas, perpendiculares e transportar ângulos com precisão.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📏 Instrumentos:</p>
            <p class="text-gray-700 dark:text-gray-300">Uso coordenado de régua, esquadro, transferidor e compasso.</p>
        </div>
    </div>
    `,

    "Lugares Geométricos": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Lugares Geométricos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Conjuntos de pontos que satisfazem uma "lei" ou propriedade comum.
        </p>
        

[Image of perpendicular bisector and angle bisector]

        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📍 Exemplos:</p>
            <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 mt-2">
                <li><strong>Circunferência:</strong> Equidistantes do centro.</li>
                <li><strong>Mediatriz:</strong> Equidistantes de dois pontos.</li>
                <li><strong>Bissetriz:</strong> Equidistantes dos lados de um ângulo.</li>
            </ul>
        </div>
    </div>
    `,

    "Mais Construções Geométricas com Régua Não Graduada e Compasso": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Construções sem Medidas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Construção "pura" de ângulos notáveis (30º, 45º, 60º, 90º) e polígonos regulares inscritos apenas com régua lisa e compasso.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🎨 Arte Matemática:</p>
            <p class="text-gray-700 dark:text-gray-300">Desenvolvemos o raciocínio espacial sem depender dos números do transferidor.</p>
        </div>
    </div>
    `,
    ...
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Triângulos: Congruência e Pontos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Estudo rigoroso dos casos de congruência (LAL, LLL, ALA).
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📍 Pontos Notáveis:</p>
            <p class="text-gray-700 dark:text-gray-300">Baricentro (gravidade), Incentro, Circuncentro e Ortocentro. O "BICO" do triângulo.</p>
        </div>
    </div>
    `,

    "Ampliando o Estudo dos Quadriláteros": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Família dos Quadriláteros</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Propriedades específicas dos paralelogramos e trapézios.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🟦 Herança:</p>
            <p class="text-gray-700 dark:text-gray-300">Entendemos a hierarquia: Todo quadrado é um retângulo e também um losango, mas o inverso não é verdadeiro.</p>
        </div>
    </div>
    `,

    // Unidade: Sistema de Equações do 1° Grau com 2 Incógnitas
    "Sistema de Equações do 1° Grau com 2 Incógnitas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Sistemas Lineares</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Introdução ao sistema linear. A solução não é um número, mas um <strong>par ordenado (x, y)</strong>.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">📈 Visão Gráfica:</p>
            <p class="text-gray-700 dark:text-gray-300">Cada equação é uma reta. A solução do sistema é exatamente o ponto onde as duas retas se cruzam.</p>
        </div>
    </div>
    `,

    "Sistema de 2 Equações do 1º Grau com 2 Incógnitas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Resolvendo Sistemas</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Métodos algébricos para encontrar a solução sem desenhar gráficos.
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🛠️ Métodos:</p>
            <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 mt-2">
                <li><strong>Substituição:</strong> Isola uma letra e troca na outra.</li>
                <li><strong>Adição:</strong> Soma as equações para "zerar" uma letra.</li>
            </ul>
        </div>
    </div>
    `,
    ...
    "Transformações Geométricas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Transformações e Homotetia</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Revisão de isometrias (reflexão, translação, rotação) e introdução à <strong>Homotetia</strong>.
        </p>
        
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🔍 Zoom:</p>
            <p class="text-gray-700 dark:text-gray-300">A homotetia trata de ampliação e redução, analisando a conservação dos ângulos mesmo quando o tamanho muda.</p>
        </div>
    </div>
    `,

    "Composição de Transformações Geométricas": `
    <h3 class="text-2xl font-bold text-brand-blue mb-4">Composição de Movimentos</h3>
    <div class="bg-white dark:bg-brand-darkCard p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
        <p class="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            Aplicação sequencial de transformações no plano cartesiano (ex: refletir e depois girar).
        </p>
        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border-l-4 border-brand-blue">
            <p class="font-bold text-brand-blue dark:text-blue-300">🎮 Programação:</p>
            <p class="text-gray-700 dark:text-gray-300">Essa lógica de passos sequenciais é a base da computação gráfica e da animação de jogos.</p>
        </div>
    </div>
    `,
